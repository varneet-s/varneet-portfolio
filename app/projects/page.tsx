        ...
        <div className="experience-timeline">
          ...
          <div className="exp-card-item" id="card-pharma">
              ...
              <div className="exp-summary-left">
                ...
                <div>
                  ...
                  <div className="exp-summary-role">
                    Freelance Consultant / Business Operations Manager
                  </div>
                </div>
              </div>
            </div>
            ...
            <p className="exp-summary-body" style={{ marginTop: '14px' }}>
              ...
              for a regional pharmaceutical distributor. Resolving field communication
              barriers and establishing automated spreadsheet workflows.
            </p>
              ...
              <div className="papao-expanded-content">
                <div className="papao-row">
                  ...
                  <div className="papao-desc">
                    Sales representatives operating in highly rigid field environments
                    with manual stock tracking; Invoicing procedures experiencing
                    persistent lag times due to paper-based logs; Supply chain buffers
                    failing to capture seasonal variations, causing frequent medicine
                    stockouts.
                  </div>
                </div>
                <div className="papao-row">
                  ...
                  <div className="papao-desc">
                    Structuring inventory mapping in Excel to automate order sheets and
                    establish real-time reporting protocols.
                  </div>
                </div>
                <div className="papao-row">
                ...
                <div className="papao-row">
                  ...
                  <div className="papao-desc">
                    Identifying inventory lag points, pinpointing specific slow-moving
                    medicine categories causing capital stagnation.
                  </div>
                </div>
                <div className="papao-row papao-row--outcome">
                  ...
                  <div className="papao-desc">
                    ...
                    Automated forecasting prevents essential stockouts by 25% and frees
                    up tied-up capital.
                  </div>
                </div>
            ...
            <details className="papao-dropdown" id="papao-lla">
              ...
              <div className="papao-expanded-content">
                <div className="papao-row">
                  <div className="papao-tag papao-tag--problem">Problem</div>
                  <div className="papao-desc">
                    Unstructured organic conversion funnels for consulting packages and
                    low brand community integration on new digital initiatives.
                  </div>
                </div>
                <div className="papao-row">
                  <div className="papao-tag papao-tag--approach">Approach</div>
                ...
                <div className="papao-row">
                  <div className="papao-tag papao-tag--process">Process</div>
                  <div className="papao-desc">
                    Standardized search metadata for 50+ high-traffic business videos.
                    Created operational brand pages and launched targeted newsletters.
                  </div>
                </div>
                <div className="papao-row">
                  <div className="papao-tag papao-tag--analysis">Analysis</div>
                  <div className="papao-desc">
                    Maintained weekly and monthly analytics sheets, tracking retention
                    trends and click funnels using Google Analytics and Excel.
                  </div>
                </div>
                <div className="papao-row papao-row--outcome">
                  <div className="papao-tag papao-tag--outcome">Outcome</div>
          ...
          <div className="exp-card-item" id="card-mad">
            ...
            <p className="exp-summary-body" style={{ marginTop: '14px' }}>
              Assisted in influencer campaign operations, tracking data, and building
              Excel-based client reporting templates for corporate brand partners.
            </p>
              ...
              <div className="papao-expanded-content">
                ...
                <div className="papao-row papao-row--outcome">
                  ...
                  <div className="papao-desc">
                    ...
                    campaigns,{' '}
                    <strong>reducing client reporting delivery time by 40%</strong> and
            ...
            <div className="exp-summary-header">
              <div className="exp-summary-left">
                ...
                <div>
                  ...
                  <div className="exp-summary-role">Account Management Intern</div>
                </div>
              </div>
            </div>
              ...
              <div className="papao-expanded-content">
                <div className="papao-row">
                  ...
                  <div className="papao-desc">
                    ...
                    real-time tracking of media spend and delivery milestones without
                    unified status sheets.
                  </div>
                </div>
                <div className="papao-row">
                  <div className="papao-tag papao-tag--approach">Approach</div>
                ...
                <div className="papao-row">
                  <div className="papao-tag papao-tag--process">Process</div>
                  <div className="papao-desc">
                    Coordinated cross-functional workflows between creative teams, media
                    buyers, and senior planners on daily deliverables.
                  </div>
                </div>
                <div className="papao-row">
                  <div className="papao-tag papao-tag--analysis">Analysis</div>
                  <div className="papao-desc">
                    Audited budget allocations against campaign pace to detect over-spend
                    or under-delivery early.
                  </div>
                </div>
                <div className="papao-row papao-row--outcome">
                  <div className="papao-tag papao-tag--outcome">Outcome</div>
                  <div className="papao-desc">
                    <strong>Maintained 100% on-time asset delivery rate</strong> across
                    Q4 client campaigns with zero budget overruns.
                  </div>
                </div>
                <div className="papao-footer-action">
                  <a
